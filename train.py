...
parser.add_argument('--data_dir', type=str, default="./flowers/", help='Which directory to pull information from')
parser.add_argument('--save_dir', type=str, default='./checkpoint.pth', help='Enable user to choose directory for saving')
parser.add_argument('--arch', type=str, default='vgg16', help='Which architecture you choose to utilize')
...
parser.add_argument('--gpu', default='gpu', type=str, help='CPU or GPU')
parser.add_argument('--epochs', type=int, default=3, help='number of cycles to train the model')
parser.add_argument('--dropout', type=float, default=0.5, help='probability for dropouts')
