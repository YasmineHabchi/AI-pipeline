...
parser.add_argument('--json_file', type=str, default='cat_to_name.json', help='Enter JSON file for category names.')
parser.add_argument('--test_file', type=str, default='flowers/train/43/image_02364.jpg', help='Prediction on a specific input image.')
parser.add_argument('--checkpoint_file', type=str, default='checkpoint.pth', help='The user enters a checkpoint file to build model from.')
parser.add_argument('--topk', type=int, default=5, help='The user enters the top "k" predictions suggested by the model.')
